...
--8<-- "layers/networking/cilium/http-sw-app.yaml:deathstar"
```
...
--8<-- "layers/networking/cilium/sw_l3_l4_policy_service.yaml"
```
...
--8<-- "layers/networking/cilium/sw_l3_l4_l7_policy.yaml"
```
...
--8<-- "layers/networking/cilium/dns-matchname.yaml"
```
...
--8<-- "layers/networking/cilium/dns-pattern.yaml"
```
...
--8<-- "layers/networking/cilium/dns-port.yaml"
```
